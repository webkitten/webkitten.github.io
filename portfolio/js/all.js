        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Проверьте email<!-- data-validator-validemail-message to override -->";
...
$(document).ready(function() {
	...
	//$(".animation_1").animated("flipInY", "rotateOut");
	...
	function scrl(){
		...
		{
			/*Лого прячется*/
			$(".logo_container").stop(true, true).fadeOut(500);
			$(".menus_butns").stop(true, true).fadeIn(500);
			min = true;
		}
		if($(document).scrollTop()<=60&&min)
		{
			/*Лого появляется*/
			$(".logo_container").stop(true, true).fadeIn(500);
			$(".menus_butns").stop(true, true).fadeOut(500);
			min = false;
		}		
	};
...
$(window).load(function() {
	...
	$("#portfolio_grid img[img]").each(function(){
